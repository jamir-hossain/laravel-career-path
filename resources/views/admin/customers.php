              ...
              <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <ul role="list" class="divide-y divide-gray-100">
                  ...
                  foreach ($customers as $customer) {
                    ...
                    print("<li class='relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8'>
                        <div class='flex gap-x-4'>
                          <img class='flex-none w-12 h-12 rounded-full bg-gray-50' src='https://ui-avatars.com/api/?name=$name&background=random' alt='$name' />

                          <div class='flex-auto min-w-0'>
                            <p class='text-sm font-semibold leading-6 text-gray-900'>
                              <a href='/admin/customer-transactions/$id'>
                                <span class='absolute inset-x-0 bottom-0 -top-px'></span>
                                $name
                              </a>
                            </p>
                            <p class='flex mt-1 text-xs leading-5 text-gray-500'>
                              <a href='/admin/customer-transactions/$id' class='relative truncate hover:underline'>
                                $email
                              </a>
                            </p>
                          </div>
